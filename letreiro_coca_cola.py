...
def restart_music():
    ...
    paused_time_total = 0  # Reinicia o tempo pausado

def toggle_pause():
    global paused, pause_start_time, paused_time_total
    if paused:
        pygame.mixer.music.unpause()
        # Soma tempo pausado ao total
...
def main():
    ...
    running = True
    play_button = pygame.Rect(20, screen_height - 60, 100, 40)
    pause_button = pygame.Rect(20, screen_height - 120, 100, 40)
    stop_button = pygame.Rect(20, screen_height - 180, 100, 40)
    ...
    while running:
        ...
        # Verifica tempo real de execução (sem contar pausas)
